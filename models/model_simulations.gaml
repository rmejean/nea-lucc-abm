...
//		save cell to: save_simplified_classif type: "asc"; //Export a landcover classification
//		ask cell {do export_landuse;}
//		save cell to: save_landuse_classif type: "asc";//Export a landuse classification
...
//
	...
	//["NAME"::name, "DEF"::is_deforest, "landuse"::landuse, "landuse2"::landuse2, "landuse3"::landuse3, "PREDIO"::predio, "HOUSEHOLD"::my_hogar];
		...
		save cell to: export_landuse_classif type: "asc";
