...
//List and definition of criteria for each LS
	list<string> criterias <- ["def_rate", "dist_via_auca", "indigena"]; // deforestation rate of the plot, distance to a first-order road (the via auca), self-identification as indigenous
	list
